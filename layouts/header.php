        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="../index.php" class="js-logo-clone">CANAANN</a>
              </div>
            </div>
                  ...
                  <li>
                    <?php
                      ...
                      if (isset($_SESSION['datos_login'])) {
                        $nombreUsuario = $_SESSION['datos_login']['nombre'];
                      ?>
                        <a href="./admin/index.php"><span class="icon icon-person"></span> <?php echo $nombreUsuario; ?></a></li>
                    <?php } else { ?>
                      <a href="./login.php"><span class="icon icon-person"></span></a></li>
                    <?php
                      }
                    ?>
                  <li>                    
