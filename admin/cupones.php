          ...
          <div class="modal-body">
            <div class="from-group">
              ...
              <div class="row">
                ...
                <div class="col-3">
                    <button type="button" class="btn btn-primary btn-small col-12" id="generar" >Generar</button>
                </div>
              </div>
            </div>
            <div class="from-group">
            ...
            <div class="from-group">
              ...
              <input type="number" min="0" name="valor" placeholder="valor" id="valor" class="form-control" require>
            </div>
