<?php 
    ...
    && isset($_POST['color'])){
        ...
        if($extension == 'jpg' || $extension == 'jpeg' || $extension == 'png'){
            ...
            header("Location: ../admin/productos.php?error=Por favor de subir una imagen valida");
        }
    }else{
        header("Location: ../admin/productos.php?error=Por favor de llenar todos los campos");
    }
?>